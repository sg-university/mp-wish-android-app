...
public interface CommentUpApi {
    ...
    @GET(ENDPOINT + "/{id}")
    Call<Result<CommentUp>> readOne(@Query("id") UUID id);
    ...
    @PUT(ENDPOINT + "/{id}")
    Call<Result<CommentUp>> updateOne(@Query("id") UUID id, @Body CommentUp commentUpToUpdate);

    @PATCH(ENDPOINT + "/{id}")
    Call<Result<CommentUp>> patchOne(@Query("id") UUID id, @Body CommentUp commentUpToPatch);

    @DELETE(ENDPOINT + "/{id}")
    Call<Result<CommentUp>> deleteOne(@Query("id") UUID id);
}
