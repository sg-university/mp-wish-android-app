 ...
 */
public class HuaweiRequestLocationUpdatesWithCallbackActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_huawei_location_request_location_updates_callback);
...
//        addLogFragment();
                    ...
                    if (locationResult != null) {
                        ...
                        if (!locations.isEmpty()) {
                            for (Location location : locations) {
                                Toast.makeText(HuaweiRequestLocationUpdatesWithCallbackActivity.this,
                    ...
                    mFusedLocationProviderClient
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(HuaweiRequestLocationUpdatesWithCallbackActivity.this, "requestLocationUpdatesWithCallback onSuccess", Toast.LENGTH_LONG).show();
                                }
                            })
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    try {
                                        ...
                                        rae.startResolutionForResult(HuaweiRequestLocationUpdatesWithCallbackActivity.this, 0);
    ...
    private void removeLocationUpdatesWithCallback() {
        try {
            ...
            voidTask.addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
                    Toast.makeText(HuaweiRequestLocationUpdatesWithCallbackActivity.this, "removeLocationUpdatesWithCallback onSuccess", Toast.LENGTH_LONG).show();
                }
            })
                    .addOnFailureListener(new OnFailureListener() {
                        @Override
    ...
    public void onClick(View v) {
        try {
            ...
            Log.e(TAG, "HuaweiRequestLocationUpdatesWithCallbackActivity Exception:" + e);
        }
    }
