...
public class HuaweiAuthDemoActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// activity_huawei_code为自定义布局文件名称
		// activity_huawei_code is the name of the custom layout file
		setContentView(R.layout.activity_huawei_auth_demo);
	...
	private void silentSignInByHwId() {
		...
		// 4、如需要获取其他受限信息，如手机号、国家和地区，则需要先申请scope，再设置请求参数；
		...
		// 4. If you need to obtain other restricted information, such as mobile phone, countries and regions, you need to apply for scope first,
